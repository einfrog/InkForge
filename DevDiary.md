...
## Day Nr. 5 - [June 12th]
            - ✅ What I worked on today: automatically log in after registration, update user when you're logged in with that user or as admin, delete user (your own profile, or as admin any profile), set up projects datatable and crud for projects.
            ...
            - 📌 Notes for tomorrow: set up remaining datatables, rewrite user CRUD to be in controller; hash passwords